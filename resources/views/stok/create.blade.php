        ...
        <div class="card-body">
            <form method="POST" action="{{ url('stok') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <select class="form-control" id="supplier_id" nama="supplier_id" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="date" class="form-control" id="stok_tanggal" nama="stok_tanggal"
                             required>
                        @error('stok_tanggal')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="number" class="form-control" id="stok_jumlah" nama="stok_jumlah"
