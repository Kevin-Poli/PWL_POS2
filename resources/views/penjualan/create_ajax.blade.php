    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Pembeli</label>
                    <input value="" type="text" nama="pembeli" id="pembeli" class="form-control" required>
                    <small id="error-pembeli" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Penjualan kode</label>
                    <input value="" type="text" nama="penjualan_kode" id="penjualan_kode" class="form-control"
                        required>
                    <small id="error-penjualan_kode" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Penjualan Tanggal</label>
                    <input value="" type="date" nama="penjualan_tanggal" id="penjualan_tanggal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" nama="jumlah" id="jumlah" class="form-control">
                        <small id="error-jumlah" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label for="harga">Harga</label>
                        <input type="number" nama="harga" id="harga" class="form-control">
    ...
    $(document).ready(function() {
        ...
        $("#save-barang").on("click", function() {
            ...
            <li id="detail-${detailId}">
                ...
                <input type="hidden" nama="penjualan_details[${detailId}][barang_id]" value="${barang_id}">
                <input type="hidden" nama="penjualan_details[${detailId}][jumlah]" value="${jumlah}">
                <input type="hidden" nama="penjualan_details[${detailId}][harga]" value="${harga}">
            </li>`;
