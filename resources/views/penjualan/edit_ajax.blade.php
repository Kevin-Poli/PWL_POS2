            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>User</label>
                        <select nama="user_id" id="user_id" class="form-control" required>
                    ...
                    <div class="form-group">
                        <label>Pembeli</label>
                        <input type="text" nama="pembeli" id="pembeli" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" nama="penjualan_kode" id="penjualan_kode" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" nama="penjualan_tanggal" id="penjualan_tanggal" class="form-control"
                            value="{{ $penjualan->penjualan_tanggal->format('Y-m-d') }}" required>
                        <small id="error-penjualan_tanggal" class="error-text form-text text-danger"></small>
                    </div>

                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="ion ion-clipboard mr-1"></i> Detail penjualan</h3>
                        </div>
                        <div class="card-body">
                            <ul class="todo-list" data-widget="todo-list" id="transaction-detail-list">
                                @foreach ($penjualan->penjualanDetail as $detail)
                                    <li id="detail-{{ $detail->detail_id }}">
                                        ...
                                        <input type="hidden" nama="penjualan_details[{{ $detail->detail_id }}][barang_id]"
                                            value="{{ $detail->barang_id }}">
                                        <input type="hidden" nama="penjualan_details[{{ $detail->detail_id }}][jumlah]"
                                            value="{{ $detail->jumlah }}">
                                        <input type="hidden" nama="penjualan_details[{{ $detail->detail_id }}][harga]"
                                            value="{{ $detail->harga }}">
                                    </li>
                                @endforeach
                            </ul>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select nama="edit_barang_id" id="edit_barang_id" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" nama="edit_jumlah" id="edit_jumlah" class="form-control"
                                min="1">
                            <small id="error-edit_jumlah" class="error-text form-text text-danger"></small>
                        </div>
                        <div class="form-group ">
                            <label for="edit_harga">Harga</label>
                            <input type="number" nama="edit_harga" id="edit_harga" class="form-control"
                                min="0">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select nama="barang_id" id="barang_id" class="form-control">
                                <option value="">- Pilih Barang -</option>
                                @foreach ($barang as $b)
                                    <option value="{{ $b->barang_id }}">{{ $b->barang_nama }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" nama="jumlah" id="jumlah" class="form-control" min="1">
                            <small id="error-jumlah" class="error-text form-text text-danger"></small>
                        </div>
                        <div class="form-group">
                            <label for="harga">Harga</label>
                            <input type="number" nama="harga" id="harga" class="form-control" min="0">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#update-detail").on("click", function() {
                ...
                $("input[nama='penjualan_details[" + detailId + "][barang_id]']").val(newBarangId);
                $("input[nama='penjualan_details[" + detailId + "][jumlah]']").val(newJumlah);
                $("input[nama='penjualan_details[" + detailId + "][harga]']").val(newHarga);
            ...
            $("#save-barang").on("click", function() {
                ...
                let newItem = `
                    <li id="detail-${newDetailId}">
                        ...
                        <input type="hidden" nama="penjualan_details[${newDetailId}][barang_id]" value="${barangId}">
                        <input type="hidden" nama="penjualan_details[${newDetailId}][jumlah]" value="${jumlah}">
                        <input type="hidden" nama="penjualan_details[${newDetailId}][harga]" value="${harga}">
                    </li>
                `;
